DROP DATABASE IF EXISTS hw_04;
CREATE DATABASE hw_04;
USE hw_04;
...
-- Задание 1. Используя JOIN-ы, выполните следующие операции:
...
-- Задание 2. Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю.
